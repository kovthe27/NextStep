...
let consultarCalificaciones = () =>{
  let lista_utilesAdmin = [];

  let request = $.ajax({
    url: "http://localhost:4000/api/consultar_calificacionesOrdenadas",
    method: "GET",
    data: {
    },
    dataType: "json",
...
let consultarCalificacionesAnno = () =>{
  let lista_utilesAdmin = [];

  let request = $.ajax({
    url: "http://localhost:4000/api/consultar_calificacionesAnno",
    method: "GET",
    data: {
    },
    dataType: "json",
