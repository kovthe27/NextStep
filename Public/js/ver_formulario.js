...
let mostrarFormulario = () => {
    ...
    let numero=0;
    document.querySelector("#txt_tituloForm").innerHTML = "Formulario: " + nombreForm;
          ...
          <div class=" bg-transparent text-left" data-gs-x="0" data-gs-y="5" data-gs-width="12" data-gs-height="1">
                        <div class="">
                            <div class="mt-3 col-md-12 ">
                                ...
                                <p id="item`+numero+`" class="form-control col-md-1 float-left ml-2 text-left mr-2" style="float: left;">`+ppeso+`</p>
